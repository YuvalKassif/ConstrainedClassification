...
def run_constraints_for_class(
    ...
    """Run constrained experiment for a single constrained class, incl. Rabkin PTO."""
    ...
    for percent in constraints_percentage_list:
        ...
        while True:
            ...
            rabkin_pto_results = constrained_classification_or(
                first_model,
                None,
                test_loader,
                class_idx,
                N_K_val,
                device,
                save_path="raw_results_PTO_Rabkin.csv",
            )
            ...
            results = {
                ...
                "Rabkin_PTO_results": rabkin_pto_results,
...
def main():
    parser = argparse.ArgumentParser(
        description="Run full experiment with Rabkin PTO (OR-based) alongside PTO/PAO"
    )
